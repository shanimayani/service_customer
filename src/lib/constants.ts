...
export const CATEGORIES = ["תמיכה", "חיוב", "אחריות", "כרטיסים", "אבידות", "כללי", "מחלקת חשמל", "מחלקת ריהוט", "מחלקת אופטיקה", "דירה ראשונה", "נציגים"];
...
const CATEGORY_COLORS: Record<string, { badge: string; border: string }> = {
  ...
  "כרטיסים": { badge: "bg-amber-100 text-amber-800 ring-amber-200", border: "border-amber-300" },
